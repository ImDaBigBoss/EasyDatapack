...
public interface CustomBlock {
     ...
     * @return the builder
     */
    static Builder builder(@NonNull String name, @NonNull String namespaceKey, @NonNull Path texture, @NonNull Path itemTexture) {
        return builder(name, namespaceKey, EasyDatapackAPI.getTexturePackManager().registerBlockTexture(texture, itemTexture));
    }
     ...
     * @return the builder
     */
    static Builder builder(@NonNull String name, @NonNull String namespaceKey, @NonNull Path texture) {
        return builder(name, namespaceKey, EasyDatapackAPI.getTexturePackManager().registerBlockTexture(texture, texture));
    }

    private static Builder builder(@NonNull String name, @NonNull String namespaceKey, TexturePackManager.@NonNull BlockData data) {
        return builder(name, namespaceKey, data.customModelData(), data.up(), data.down(), data.north(), data.east(), data.south(), data.west(), data.parent());
    }
